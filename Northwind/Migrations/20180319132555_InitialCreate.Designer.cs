...
namespace Northwind.Migrations
{
    ...
    [Migration("20180319132555_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northwind.Domain.Customers.CustomerCustomerDemo", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasColumnName("CustomerID")
                        .HasMaxLength(5);
            ...
            modelBuilder.Entity("Northwind.Domain.Customers.CustomerDemographics", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("CustomerTypeID")
            ...
            modelBuilder.Entity("Northwind.Domain.Orders.Shipper", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Domain.Orders.Supplier", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Domain.Products.Category", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Domain.Customers.CustomerCustomerDemo", b =>
                {
                    ...
                    b.HasOne("Northwind.Domain.Customers.CustomerDemographics", "CustomerType")
                        .WithMany("CustomerCustomerDemo")
            ...
            modelBuilder.Entity("Northwind.Domain.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Northwind.Domain.Orders.Shipper", "Shipper")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Northwind.Domain.Products.Product", b =>
                {
                    b.HasOne("Northwind.Domain.Products.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId");

                    b.HasOne("Northwind.Domain.Orders.Supplier", "Supplier")
                        .WithMany("Products")
